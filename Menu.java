...
public class Menu {
  ...
  //constructor to initilaize menu
  public Menu() {
  ...
  // background of menu using arraylist to initalzie buttons
  public class TestPane extends JPanel{
    ...
    public TestPane(){
      ...
      try{
        backgroundImage = ImageIO.read(new File("\\Users\\Ramish Saeed\\Desktop\\robotSokoban\\download.jpg"));
      }catch(Exception e)
      {
    ...
    //to repaint the whole frame when resizing
    @Override
    ...
    //use keyboard enter button to select
    ...
    //class menuaction to implement actionlistener
