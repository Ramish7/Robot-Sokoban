...
public class Board extends JPanel {
 ...
 public Board() {
  JLabel backround = new JLabel(new 
    ImageIcon("\\Users\\serkan\\Desktop\\Sokoban\\bin\\RobotSokoban\\background.jpg"));
  add(backround);
 ...
 public void drawMap(Graphics g){
  ...
  for(int i = 0; i < figures.size();i++){
   ...
   g.drawString("your score is: "+player.getEnergy(), 30, 45);
 ...
 class Listener extends KeyAdapter {
  File teleport = new File("\\Users\\serkan\\Desktop\\robotSokoban\\bin\\robotSokoban\\teleportSound.WAV");
  File boxMove = new File("\\Users\\serkan\\Desktop\\robotSokoban\\bin\\robotSokoban\\pushboxSound.WAV");
  File Step = new File("\\Users\\serkan\\Desktop\\robotSokoban\\bin\\robotSokoban\\stepSound.WAV");
  File Switch = new File("\\Users\\serkan\\Desktop\\robotSokoban\\bin\\robotSokoban\\switchSound.WAV");
